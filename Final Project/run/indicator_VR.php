...
<title>IndicatorVR-Forecaster</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Indicator VR</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Indicator VR</h1>
        ...
        <div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">VR</div>
                    ...
                    var filename= 'json/VR/'+Stockname+'.json';
