...
<title>IndicatorMACD-Forecaster</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Indicator MACD</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Indicator MACD</h1>
        ...
        <div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">MACD</div>
                        ...
                        <h2><?php echo $_POST['submit'];?></h2>
                                <?php
                                   ...
                                   // $VR->predict_VR($_POST["submit"]);
                                    $MACD->Analysis_MACD($_POST["submit"]);
                                    json_MACD();
                                    echo "</br></br>";
                                ?>
                    ...
                    var filename= 'json/MACD/'+Stockname+'.json';
